...
public:
    ...
    void setUpPointLight(Shader& lightingShader)
    {
        ...
        if (lightNumber == 1) {
            ...
            lightingShader.setVec3("pointLights[2].emissive", emissive);
        }
            ...
            lightingShader.setVec3("pointLights[3].emissive", emissive);
        }
            ...
            lightingShader.setVec3("pointLights[4].emissive", emissive);
        }
            ...
            lightingShader.setVec3("pointLights[5].emissive", emissive);
        }
            ...
            lightingShader.setVec3("pointLights[6].emissive", emissive);
        }
            ...
            lightingShader.setVec3("pointLights[7].emissive", emissive);
        }
            ...
            lightingShader.setVec3("pointLights[8].emissive", emissive);
        }
            ...
            lightingShader.setVec3("pointLights[9].emissive", emissive);
        }
            ...
            lightingShader.setVec3("pointLights[10].emissive", emissive);
        }
            ...
            lightingShader.setVec3("pointLights[11].emissive", emissive);
        }
            ...
            lightingShader.setVec3("pointLights[12].emissive", emissive);
        }
            ...
            lightingShader.setVec3("pointLights[13].emissive", emissive);
        }
            ...
            lightingShader.setVec3("pointLights[14].emissive", emissive);
        }
            ...
            lightingShader.setVec3("pointLights[15].emissive", emissive);
        }
            ...
            lightingShader.setVec3("pointLights[16].emissive", emissive);
        }
            ...
            lightingShader.setVec3("pointLights[17].emissive", emissive);
        }
    }
